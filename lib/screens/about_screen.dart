                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text(snapshot.data!.getTitle(), style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w700), textAlign: TextAlign.center,),
                                const SizedBox(height: 30,),
                                Text(snapshot.data!.getDescription(), style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500),)
                              ],
                            ),
                          ),
                        ),
